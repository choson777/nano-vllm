...
from nanovllm.spec_llm import AsyncLLM
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="/data3/szf_hf/huggingface/model/Qwen3-8B/")
    parser.add_argument("--draft_model", type=str, default="/data3/lqc/models/qwen3-0.6b")
